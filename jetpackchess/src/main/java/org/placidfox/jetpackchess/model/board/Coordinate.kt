...
enum class Coordinate {
    ...
    companion object {
        ...
        fun getTwoAdjacentsCoordinate(coordinate: Coordinate): List<Coordinate?>{
            val coordinateLeft: Coordinate? =
                if(coordinate.file > 1 ){
                    Coordinate.fromNumCoordinate(coordinate.file - 1, coordinate.rank)
                } else {
                    null
            ...
            val coordinateRight: Coordinate? =
                if(coordinate.file < 8 ){
                    Coordinate.fromNumCoordinate(coordinate.file + 1, coordinate.rank)
                } else {
                    null
            ...
            return listOf(coordinateLeft, coordinateRight)
